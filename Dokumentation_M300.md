...
_Dokumentation Modul 300 von Almen Elezi_

---

## Inhaltsverzeichnis
- [M300 – Services \& Cloud Computing](#m300--services--cloud-computing)
  - [Inhaltsverzeichnis](#inhaltsverzeichnis)
  - [Repository erstellen](#repository-erstellen)
  - [SSH-Key erstellen (lokal)](#ssh-key-erstellen-lokal)
  - [SSH-Key dem SSH-Agent hinzufügen](#ssh-key-dem-ssh-agent-hinzufügen)
  - [SSH-Key bei GitHub hinzufügen](#ssh-key-bei-github-hinzufügen)
  - [Client konfigurieren](#client-konfigurieren)
  - [Repository klonen (Test)](#repository-klonen-test)
  - [Repository herunterladen \& aktualisieren (clone/pull)](#repository-herunterladen--aktualisieren-clonepull)
    - [Ordner für das Repository erstellen](#ordner-für-das-repository-erstellen)
    - [Repository mit SSH klonen](#repository-mit-ssh-klonen)
    - [Repository aktualisieren und Status prüfen](#repository-aktualisieren-und-status-prüfen)
- [Cloud Computing](#cloud-computing)
  - [Fragen](#fragen)
    ...
    - [Was ist der Unterschied zur manuellen Installation der VM?](#was-ist-der-unterschied-zur-manuellen-installation-der-vm)
  - [Vagrant](#vagrant)
  ...
  - [Cloud Computing](#cloud-computing-1)
    ...
    - [Cloud-Arten](#cloud-arten)
    - [Vorteile der Cloud](#vorteile-der-cloud)
  - [Infrastructure as Code (IaC)](#infrastructure-as-code-iac)
    - [Vorteile von IaC](#vorteile-von-iac)
    - [Typische IaC-Toolarten](#typische-iac-toolarten)
  - [Vagrant](#vagrant-1)
    - [Wichtige Befehle](#wichtige-befehle)
    - [Boxen](#boxen)
    - [VM erstellen](#vm-erstellen)
    - [Vagrantfile (Beispiel)](#vagrantfile-beispiel)
    - [Provisioning (Beispiel)](#provisioning-beispiel)
    - [Provider (Beispiel)](#provider-beispiel)
    - [Synced Folders](#synced-folders)
  - [Reflexion](#reflexion)
  - [LB2 – Hands-on](#lb2--hands-on)
  - [Feintuning](#feintuning)
  - [25 – Sicherheit (Fragen)](#25--sicherheit-fragen)
    - [Was ist der Unterschied zwischen einem Webserver und einem Reverse Proxy?](#was-ist-der-unterschied-zwischen-einem-webserver-und-einem-reverse-proxy)
    - [Was versteht man unter einer White List?](#was-versteht-man-unter-einer-white-list)
    - [Was wäre die Alternative zum Absichern einzelner Server mit einer Firewall?](#was-wäre-die-alternative-zum-absichern-einzelner-server-mit-einer-firewall)
    - [Was ist der Unterschied zwischen der Datei `id_rsa` und `id_rsa.pub`?](#was-ist-der-unterschied-zwischen-der-datei-id_rsa-und-id_rsapub)
    - [Wo darf ein SSH-Tunnel nicht angewendet werden?](#wo-darf-ein-ssh-tunnel-nicht-angewendet-werden)
    - [Wozu dient die Datei `authorized_keys`?](#wozu-dient-die-datei-authorized_keys)
    - [Wozu dient die Datei `known_hosts`?](#wozu-dient-die-datei-known_hosts)
  - [25 – Sicherheit (Umsetzung)](#25--sicherheit-umsetzung)
    - [Firewall \& Reverse Proxy](#firewall--reverse-proxy)
    - [UFW Firewall](#ufw-firewall)
    - [Installation und Aktivierung](#installation-und-aktivierung)
    - [SSH-Port freigeben](#ssh-port-freigeben)
    - [Firewall-Regeln konfigurieren](#firewall-regeln-konfigurieren)
    - [Reverse Proxy](#reverse-proxy)
  - [30 – Container (Fragen)](#30--container-fragen)
    - [Container allgemein](#container-allgemein)
    - [Docker](#docker)
    - [Docker Hub](#docker-hub)
  - [Container](#container)
    - [Merkmale von Containern](#merkmale-von-containern)
  - [Geschichte der Container](#geschichte-der-container)
  ...
  - [Docker Befehle](#docker-befehle)
    ...
    - [Container und Images löschen](#container-und-images-löschen)
    - [Container starten und stoppen](#container-starten-und-stoppen)
    - [Informationen zu Containern](#informationen-zu-containern)
  - [Dockerfile](#dockerfile)
    - [Image bauen](#image-bauen)
    - [Container starten](#container-starten)
    - [Funktionsfähigkeit prüfen](#funktionsfähigkeit-prüfen)
  - [Docker Konzepte](#docker-konzepte)
    - [Build Context](#build-context)
    - [Layer (Imageschichten)](#layer-imageschichten)
    - [Wichtige Dockerfile-Anweisungen](#wichtige-dockerfile-anweisungen)
  - [Netzwerk-Anbindung von Containern](#netzwerk-anbindung-von-containern)
    - [Ports veröffentlichen](#ports-veröffentlichen)
    - [Port im Dockerfile freigeben](#port-im-dockerfile-freigeben)
    - [Zugriff vom Host auf MySQL im Container](#zugriff-vom-host-auf-mysql-im-container)
  - [Container-Networking](#container-networking)
    - [Standard-Netzwerke](#standard-netzwerke)
    - [Wichtige Befehle](#wichtige-befehle-1)
    - [Container ohne Netzwerk starten](#container-ohne-netzwerk-starten)
    - [Container mit Host-Netzwerk starten](#container-mit-host-netzwerk-starten)
    - [Eigenes Bridge-Netzwerk erstellen](#eigenes-bridge-netzwerk-erstellen)
    - [Container-Linking (veraltet)](#container-linking-veraltet)
  - [04 – Volumes](#04--volumes)
    - [Volume im Dockerfile definieren](#volume-im-dockerfile-definieren)
  - [Volumes (Details)](#volumes-details)
    - [Eigenschaften von Volumes](#eigenschaften-von-volumes)
    - [Beispiel: Volume im Container erstellen](#beispiel-volume-im-container-erstellen)
    - [Beispiel: Host-Verzeichnis als Volume einbinden](#beispiel-host-verzeichnis-als-volume-einbinden)
    - [Beispiel: Einzelne Datei einbinden](#beispiel-einzelne-datei-einbinden)
  - [Datencontainer (veraltet)](#datencontainer-veraltet)
    - [Beispiel: Datencontainer erstellen](#beispiel-datencontainer-erstellen)
    - [Zweiten Container mit Datencontainer starten](#zweiten-container-mit-datencontainer-starten)
  - [Named Volumes](#named-volumes)
    - [Beispiele](#beispiele-1)
    - [Volume im Dockerfile definieren](#volume-im-dockerfile-definieren-1)
  - [05 – Image-Bereitstellung](#05--image-bereitstellung)
    - [Namensgebung von Images](#namensgebung-von-images)
    - [Images bauen und taggen](#images-bauen-und-taggen)
    - [Regeln für Tags](#regeln-für-tags)
    - [Achtung beim `latest`-Tag](#achtung-beim-latest-tag)
  - [Docker Hub](#docker-hub-1)
    - [Docker Hub einrichten](#docker-hub-einrichten)
    - [Weitere Befehle](#weitere-befehle)
  - [Export und Import von Containern und Images](#export-und-import-von-containern-und-images)
  ...
  - [Private Registry](#private-registry)
    - [Private Docker Registry starten](#private-docker-registry-starten)
    - [Docker-Client auf lokale Registry einstellen](#docker-client-auf-lokale-registry-einstellen)
    - [Images von der lokalen Registry nutzen](#images-von-der-lokalen-registry-nutzen)
  - [LB3 – Hands-on](#lb3--hands-on)
    - [VM erstellen](#vm-erstellen-1)
    - [Docker installieren](#docker-installieren)
    - [Docker-Berechtigungsproblem lösen](#docker-berechtigungsproblem-lösen)
    - [Dockerfile erstellen](#dockerfile-erstellen)
    - [Docker-Image bauen](#docker-image-bauen)
    - [Container starten und testen](#container-starten-und-testen)
    - [Ghost auf alternativen Port starten](#ghost-auf-alternativen-port-starten)
  - [50 - Projekte](#50---projekte)
    - [docker-minecraft-server](#docker-minecraft-server)
    - [Server starten und testen](#server-starten-und-testen)
